...
and/or Redis in the same way as, for instance, there is pgmq.  (*Update:
we have since built our own solution to this problem called [Absurd](https://github.com/earendil-works/absurd)*)
